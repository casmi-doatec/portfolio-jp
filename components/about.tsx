        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7 space-y-10 order-1 lg:order-2">
            ...
            <div className="space-y-6 font-serif">
              ...
              >
                はじめまして。遠藤悠晴と申します。高校生の頃からの夢は、IT業界の第一人者になることでした。学生時代はpaizaのAランク取得を目標に、学校から帰った後も夜遅くまでプログラミングの学習に打ち込み、高校卒業時に合格。早稲田文理専門学校へ進学しました。
              </p>
              <p
                className={`text-sm lg:text-base text-muted-foreground font-light leading-[2.2] ${
              ...
              >
                専門学校では優秀な学生エンジニアの一人として評価される機会も多くありました。その後、東洋学園大学の3年生に編入し、数理・データサイエンス・AI教育プログラムを通じてAIの基礎知識やデータ分析のスキルを習得。PBLではITを活用したマーケティング戦略の立案やデジタルツールの活用方法を実践的に学びました。
              </p>
              <p
                className={`text-sm lg:text-base text-muted-foreground font-light leading-[2.2] ${
